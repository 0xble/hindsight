...
class MonitoringApi:
    ...
    @validate_call
    async def readiness_endpoint_health_ready_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._readiness_endpoint_health_ready_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def readiness_endpoint_health_ready_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def readiness_endpoint_health_ready_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _readiness_endpoint_health_ready_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
