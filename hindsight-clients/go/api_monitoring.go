...
type ApiReadinessEndpointHealthReadyGetRequest struct {
	ctx context.Context
	ApiService *MonitoringAPIService
}

func (r ApiReadinessEndpointHealthReadyGetRequest) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.ReadinessEndpointHealthReadyGetExecute(r)
}

/*
ReadinessEndpointHealthReadyGet Readiness probe
...
Returns 200 when the API can serve traffic (database reachable), 503 otherwise. Identical to /health, which stays supported as its alias.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReadinessEndpointHealthReadyGetRequest
*/
func (a *MonitoringAPIService) ReadinessEndpointHealthReadyGet(ctx context.Context) ApiReadinessEndpointHealthReadyGetRequest {
	return ApiReadinessEndpointHealthReadyGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return interface{}
func (a *MonitoringAPIService) ReadinessEndpointHealthReadyGetExecute(r ApiReadinessEndpointHealthReadyGetRequest) (interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MonitoringAPIService.ReadinessEndpointHealthReadyGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
