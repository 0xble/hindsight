...
| `retainContext`         | `coding agent session`               | the `context` sent with every session write-back. Extraction reads it to decide whose claim a sentence is, so the default's silence on authorship lets an assistant's proposal be recorded as the user's decision. Accepts the same `{placeholder}` templates as `retainTags`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
